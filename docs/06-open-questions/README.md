...
| [OQ-005](OQ-005-extension-isolation.md) | How are third-party extensions isolated and versioned? | Undecided — requirements only | **RESOLVED** → [ADR-0008](../03-adrs/ADR-0008-extension-isolation-and-contract-versioning.md) (per this page's own recommendation — no mechanism chosen) |
