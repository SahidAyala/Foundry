...
| **M2** — Reusable production + mock executor | Shipped | Authored Pipeline documents (`.foundry/pipelines/*.json`) are the reusable-Act artifact, per [ADR-0004](../03-adrs/ADR-0004-reusable-act-template-format-and-evolution-policy.md) (ratified 2026-07-20); `executor.ScriptedExecutor` is the fixture Executor; bounded repair works. |
...
| [RFC-0002](../01-rfcs/RFC-0002-pipeline-execution-runtime.md) — Pipeline execution runtime | No | **~85%.** Phases 1–6 and 8 shipped: Step trace on `Act`, `Strategy`/`PipelineStrategy`, Approve/Record as declared Step kinds, `FixedStrategy` fully retired, Router (explicit-pin), interactive shell. **Both of Phase 0's prerequisite ADRs now accepted:** [ADR-0005](../03-adrs/ADR-0005-executor-contract-and-capability-model.md) (Executor contract) and [ADR-0004](../03-adrs/ADR-0004-reusable-act-template-format-and-evolution-policy.md) (Reusable-Act template format, ratified 2026-07-20 — §3 below). | **Phase 7** — capability-based negotiation/failover (cost/latency/quality weighting) — deliberately deferred, no real multi-Executor-per-Capability case yet. [ADR-0004](../03-adrs/ADR-0004-reusable-act-template-format-and-evolution-policy.md) is ratified but its Decision 4 (strict, descriptive unknown-field rejection) is not yet implemented in code — tracked as follow-up work. |
...
- **Accepted (5):** [ADR-0000](../03-adrs/ADR-0000-governance-and-ratification-process.md) (governance), [ADR-0001](../03-adrs/ADR-0001-language-and-toolchain.md) (Go), [ADR-0004](../03-adrs/ADR-0004-reusable-act-template-format-and-evolution-policy.md) (Reusable-Act template format — ratified 2026-07-20; Decision 4's code not yet implemented, see §2 above), [ADR-0005](../03-adrs/ADR-0005-executor-contract-and-capability-model.md) (Executor contract — implemented), [ADR-0010](../03-adrs/ADR-0010-vcs-pr-integration-and-apply-targets.md) (VCS/PR — implemented).
...
- **2026-07-20** — Drafted and ratified [ADR-0004](../03-adrs/ADR-0004-reusable-act-template-format-and-evolution-policy.md) (Reusable-Act template format & evolution policy) under [ADR-0000](../03-adrs/ADR-0000-governance-and-ratification-process.md), satisfying RFC-0002 Phase 0's second prerequisite ADR. Decision 4's code (strict, descriptive unknown-field rejection) is deliberately deferred past ratification — tracked as follow-up implementation work.
