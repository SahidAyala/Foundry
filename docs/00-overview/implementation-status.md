...
- **Accepted (5):** [ADR-0000](../03-adrs/ADR-0000-governance-and-ratification-process.md) (governance), [ADR-0001](../03-adrs/ADR-0001-language-and-toolchain.md) (Go), [ADR-0004](../03-adrs/ADR-0004-reusable-act-template-format-and-evolution-policy.md) (Reusable-Act template format — ratified and implemented 2026-07-20), [ADR-0005](../03-adrs/ADR-0005-executor-contract-and-capability-model.md) (Executor contract — implemented), [ADR-0010](../03-adrs/ADR-0010-vcs-pr-integration-and-apply-targets.md) (VCS/PR — implemented).
- **Drafted, pending ratification (1):** [ADR-0009](../03-adrs/ADR-0009-cli-and-output-contract.md) (CLI & output contract) — drafted 2026-07-20. Ratifies the interactive-primary product shape, a pre-1.0 "change freely, but never silently" policy for the flag CLI and slash commands, the existing exit-code convention, and declines a JSON output mode for now. Also decides fixing the phantom `/help` banner reference and renaming `PipelineProvider`→`PipelineSource` (RFC-0003 §5's flagged terminology tension) — none of Decisions 6–8 are implemented yet. Status: Proposed.
