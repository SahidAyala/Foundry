...
> **Partially resolved governance question:** [ADR-0014](../03-adrs/ADR-0014-principle-priority-ordering.md) (2026-07-26) ratifies that when a numbered Principle above and a Value above conflict, the Value always wins — formalizing the "never compromised" label these Values already carry. **Still open:** any priority ordering *within* the 8 numbered Principles, or *within* the 6 Values, when two from the same tier conflict. Until that narrower question is resolved, treat those conflicts as escalations, not as something to settle silently. Tracked in [roadmap.md](roadmap.md) (item 2).
>
> A separate, related question — *whether there was any process at all for accepting decisions* — is also resolved: [ADR-0000](../03-adrs/ADR-0000-governance-and-ratification-process.md) defines a lightweight, sole-maintainer-led ratification process. That ADR settles *who can accept a decision and how*; ADR-0014 above settles the Values-vs-Principles tier question; the still-open within-tier orderings remain the open question above.
