...
| **Act as domain center; Knowledge as durable medium** | PROVISIONAL (ratified working model via [ADR-0015](../03-adrs/ADR-0015-domain-center-act-and-knowledge.md)) | [domain.md](../02-architecture/domain.md) | [OQ-001](../06-open-questions/OQ-001-domain-center.md) — RESOLVED (center only; Strategy/rejected-Act semantics remain open per [OQ-002](../06-open-questions/OQ-002-pipeline-as-strategy.md)) |
